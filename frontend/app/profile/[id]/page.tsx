...
export default function ProfilePage() {
  ...
  const fetchUserData = async () => {
    ...
    try {
      ...
      localStorage.setItem("compath_user", JSON.stringify({
        id: response.user.id,
        name: response.user.name,
        email: response.user.email,
      ...
      const errorMessage = error.message.includes('Token') || error.message.includes('401')
      ...
      toast({
        ...
        description: `Erro: ${errorMessage} Token: ${getToken() || "Nenhum"} ID: ${id}`,
        variant: "destructive",
      });
  ...
  useEffect(() => {
    ...
    if (!currentUser || !currentUser.id) {
      console.log('No current user or ID in localStorage, redirecting to login');
      toast({
    ...
    if (currentUser.id !== id) {
      console.log('ID mismatch. Current user ID:', currentUser.id, 'URL ID:', id);
      toast({
      ...
      <main className="flex-grow max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="space-y-6">
          <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
            <CardHeader>
              <CardTitle className="text-blue-900 dark:text-white">Perfil</CardTitle>
            </CardHeader>
            <CardContent>
            ...
            <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
              <CardHeader>
                <div className="flex justify-between items-center">
                  <CardTitle className="text-blue-900 dark:text-white">Informações Pessoais</CardTitle>
                  {!isEditing && (
                    <Button
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="name" className="text-gray-700 dark:text-gray-200">Nome</Label>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="phone" className="text-gray-700 dark:text-gray-200">Telefone</Label>
                    <div className="flex items-center">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="location" className="text-gray-700 dark:text-gray-200">Localização</Label>
                    <div className="flex items-center">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="company" className="text-gray-700 dark:text-gray-200">Empresa</Label>
                    <div className="flex items-center">
                ...
                {isEditing && (
                  <div className="flex justify-end space-x-2 mt-6">
                    ...
                    <Button
                      type="submit"
                      className="bg-blue-900 text-white hover:bg-blue-800 dark:bg-gray-600 dark:hover:bg-gray-500"
                    >
                      Salvar Alterações
                    </Button>
                  </div>
